...
def train():
    ...
    parser.add_argument("--htr_path", type=str, default='results_writer_id/wd0/model_0125', help='htr checkpoint path')
    parser.add_argument("--writer_id_path", type=str, default='results_htr/htr0', help='writerid config path')
